...
struct layer{
	...
	CLArray combine_gpu;
	CLArray combine_delta_gpu;

	CLArray prev_state_gpu;
	CLArray forgot_state_gpu;
	CLArray forgot_delta_gpu;
	CLArray state_gpu;
	CLArray state_delta_gpu;
	CLArray gate_gpu;
	CLArray gate_delta_gpu;
	CLArray save_gpu;
	CLArray save_delta_gpu;
	CLArray concat_gpu;
	CLArray concat_delta_gpu;

	CLArray binary_input_gpu;
	CLArray binary_weights_gpu;

	CLArray mean_gpu;
	CLArray variance_gpu;

	CLArray rolling_mean_gpu;
	CLArray rolling_variance_gpu;

	CLArray variance_delta_gpu;
	CLArray mean_delta_gpu;

	CLArray x_gpu;
	CLArray x_norm_gpu;
	CLArray weights_gpu;
	CLArray weight_updates_gpu;
	CLArray weight_change_gpu;

	CLArray biases_gpu;
	CLArray bias_updates_gpu;
	CLArray bias_change_gpu;

	CLArray scales_gpu;
	CLArray scale_updates_gpu;
	CLArray scale_change_gpu;
